...
$.fixedToolbars = (function(){
	...
	var showEventCallback = function(event)
	{
	...
	$(function() {
		$(document)
			...
			.bind('scrollstart.toolbar',function toolbarScrollStart(event){
			...
			.bind('scrollstop.toolbar',function tollbarScrollStop(event){
				if( $(event.target).closest(ignoreTargets).length ){ return; }
				scrollTriggered = false;
				if (autoHideMode) {
					autoHideMode = false;
